      ...
      <ScrollView style={styles.container}>
        <View style={styles.header}>
          {this.state.selectedAvatar ? (
            <Image
              source={{uri: this.state.selectedAvatar.path}}
              style={styles.avatar}
            />
          ) : (
                ...
                <TouchableOpacity
                  ...
                  <View style={styles.tag}>
                    ...
                    <Image
                      source={{
                        uri: url(
                          _.find(this.props.instruments, {_id: selected}).image,
                        ),
                      }}
