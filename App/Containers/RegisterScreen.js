  ...
  async onSignUp () {
    ...
    if (response.ok) {
      ...
      if (this.props.auth.deviceToken) {
        ...
        api
          .registerDeviceToken({
            device_token: this.props.auth.deviceToken,
            ...
            <View style={styles.container}>
              ...
              <View style={styles.middleSection}>
                ...
                <RoundedInput
                  ...
                  error={
                    this.state.errors && this.state.errors.first('password')
                  }
                  autoCorrect={false}
                  autoCapitalize={'none'}
                  secureTextEntry
                  onSubmitEditing={() =>
                    this.refs.inputPasswordConfirmation.focus()
                  }
                />
                <RoundedInput
                  ...
                  error={
                    this.state.errors &&
                    this.state.errors.first('password_cofirmation')
                  }
                  autoCorrect={false}
                  autoCapitalize={'none'}
                  secureTextEntry
              ...
              <TouchableOpacity
                ...
                onPress={() => Actions.loginScreen({type: ActionConst.RESET})}>
