...
class NewAlbumScreen extends Component {
  ...
  async onSubmit () {
    ...
    let response = await api.addAlbum({
      name,
      description,
      instrument_ids: selectedInstruments,
      band_id: band ? band._id : null,
    })
        ...
        <View style={styles.albumInputs}>
          <View style={styles.addCoverBlock}>
            ...
            <TouchableOpacity
              ...
              onPress={() => this.onCoverPress()}>
              {this.state.cover ? (
                <Image
                  style={styles.albumCover}
                  source={{uri: this.state.cover.path}}
                />
              ) : null}
              {this.state.cover ? (
                <View style={styles.addCoverOverlay} />
              ) : null}
